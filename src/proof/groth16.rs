...
impl Prover<'_, Scalar> for Groth16Prover<Bls12> {
  ...
  fn new(reduction_count: usize) -> Self {
    Groth16Prover { reduction_count, _p: PhantomData::<Bls12> }
  }
...
mod tests {
  ...
  fn outer_prove_aux0(
    ...
    if check_constraint_systems {
      ...
      let multi_frames =
        MultiFrame::from_frames(DEFAULT_REDUCTION_COUNT, &frames, s);
  ...
  pub fn check_cs_deltas(
    ...
    let blank_frame =
      MultiFrame::<Scalar, _, _>::blank(DEFAULT_REDUCTION_COUNT);
