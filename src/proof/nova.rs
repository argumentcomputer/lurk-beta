...
pub mod tests {
    ...
    macro_rules! test_aux {
        ( $m:ty, $a:expr, $b:expr, $c:expr, $d:expr, $e:expr, $f:expr, $g:expr, $h:expr $(,)? ) => {{
            test_aux::<_, _, $m>($a, $b, $c, $d, $e, $f, $g, $h, 1);
            test_aux::<_, _, $m>($a, $b, $c, $d, $e, $f, $g, $h, 2);
            test_aux::<_, _, $m>($a, $b, $c, $d, $e, $f, $g, $h, 5);
        }};
    }
