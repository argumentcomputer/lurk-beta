...
impl<'a, F: CurveCycleEquipped, C: Coprocessor<F>> RecursiveSNARKTrait<'a, F, C, C1LEM<'a, F, C>>
    for Proof<'a, F, C>
where
...
impl<'a, F: CurveCycleEquipped, C: Coprocessor<F> + 'a> Prover<'a, F, C, C1LEM<'a, F, C>>
