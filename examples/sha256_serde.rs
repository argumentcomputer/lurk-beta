...
/// `cargo run --release --example sha256_serde 1 f5a5fd42d16a20302798ef6ed309979b43003d2320d9f0e8ea9831a92759fb4b false`
fn main() {
    let args: Vec<String> = env::args().collect();

    let num_of_64_bytes = 1;
    let expect =
        hex::decode("f5a5fd42d16a20302798ef6ed309979b43003d2320d9f0e8ea9831a92759fb4b".to_string())
            .unwrap();
    let setup_only = false;
    ...
    let pp = public_params::<Sha256Coproc<Fr>>(REDUCTION_COUNT, true, lang_rc.clone()).unwrap();
