...
impl Pos {
    /// Use the range information in a Position to pretty-print that range within a string
    pub fn range(
        input: String,
        from_line: usize,
        from_column: usize,
...
//            f,
//            "{}@{}:{}-{}:{}",
//            self.input, self.from_line, self.from_column, self.upto_line, self.upto_column
//        )
//    }
//}
