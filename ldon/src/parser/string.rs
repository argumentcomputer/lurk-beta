...
pub fn parse_string<'a, F: LurkField>(
  ...
  move |from: Span| {
    delimited(char(delim), parse_string_inner(delim, true, ""), char(delim))(
      from,
    )
  }
}
...
pub mod tests {
  ...
  fn unit_parse_string() {
    ...
    test_parse(parse_string_inner('"', true, ""), "", Some(String::from("")));
    test_parse(parse_string_inner('"', true, ""), " ", Some(String::from(" ")));
    test_parse(parse_string_inner('"', false, ""), " ", Some(String::from("")));
    test_parse(
